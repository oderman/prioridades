...
<?php
$consulta = $pdo->prepare("SELECT * FROM revistas WHERE rev_id='".$_GET["idR"]."'");
$consulta->execute();
		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<form id="form_subir" action="revistas-actualizar.php" method="post" enctype="multipart/form-data">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control form-control-sm" id="titulo" name="titulo" required value="<?=$datos['rev_titulo'];?>">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="date" class="form-control form-control-sm" id="fecha" name="fecha" placeholder="col-form-label-sm" required value="<?=$datos['rev_publicacion'];?>">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											...
											<img src="img/portadas/<?=$datos['rev_portada'];?>" width="100">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<textarea class="form-control" id="descripcion" name="descripcion" rows="3"><?=$datos['rev_descripcion'];?></textarea>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="form-group m-0">
										<input type="text" class="form-control" data-role="tagsinput" id="keywords" name="keywords" value="<?=$datos['rev_keywords'];?>">
					...
					<script>
											...
											function subir_archivos(form){
												...
												peticion.addEventListener("load", () => {
													...
													function redirect(){
														location.href='revistas.php?msg=3';
													}

												});

												peticion.open("POST", "revistas-actualizar.php");
