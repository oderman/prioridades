							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group row">
										<label for="nombres" class="col-sm-2 col-form-label col-form-label-sm">Nombres y apellidos</label>
										<div class="col-sm-6">
											<input type="text" class="form-control form-control-sm" id="nombres" name="nombres" required value="<?=$datos['usr_nombres']." ".$datos['usr_apellidos'];?>" readonly>
										</div>
									</div>
