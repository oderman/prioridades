...
$consulta = $pdo->prepare("SELECT rev_id AS id, rev_titulo AS title, rev_descripcion AS description, CONCAT('https://revistaprioridades.com/admin/img/portadas/', rev_portada) AS image, MONTHNAME(rev_publicacion) AS month FROM revistas
